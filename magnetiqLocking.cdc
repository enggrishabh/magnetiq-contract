...
pub contract MagnetiqLocking {
    ...
    pub event TokenLocked(id: UInt64, duration: UFix64, expiryTimestamp: UFix64)

    // Emitted when a Token is unlocked
    pub event TokenUnlocked(id: UInt64)
    ...
    init() {
        ...
        self.account.save(<-admin, to: /storage/MagnetiqLockingAdmin)
    }
}
